    ...
    <div className="flex flex-1 items-center justify-center p-4">
      <div className="w-full max-w-sm rounded-xl border border-outline-variant/20 bg-surface-container-lowest p-8 shadow-[0px_4px_20px_rgba(103,75,181,0.08)]">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h1 className="font-headline text-xl font-semibold text-primary">{t.signup.title}</h1>
        </div>
        ...
        {success ? (
          <>
            ...
            <Link href="/login" className="font-label block text-center text-xs text-primary hover:underline">
              {t.signup.loginLink}
            </Link>
          </>
        ) : (
