...
export default function AvatarMenu({ email, openUpward = false }: { email: string; openUpward?: boolean }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          className={`absolute z-[1100] w-64 rounded-xl border border-outline-variant/20 bg-surface-container-lowest shadow-[0px_8px_24px_rgba(103,75,181,0.12)] ${
